...
public class DrawPanel extends JPanel {
	...
	TextItem text = new TextItem(); // The TextItem displayed in this image.
	                                        // It can be retrieved with getTextItem but can't be set.
	
	Image backgroundImage = null;  // Seven properties that have "get" and "set" methods.
	Color borderColor = Color.DARK_GRAY;
	int borderThickness = 3;
	Color gradientOverlayColor = Color.WHITE;
	boolean horizontalOverlay = false;
	BufferedImage currentDrawImage;
	
	ArrayList<ImageItem> images = new ArrayList<ImageItem>();  // three objects for internal use only
